...
const confirmSubject = "Confirm your email"

func SendVerifyEmail(user users.User) error {
	err := SendPlainEmail(user,confirmSubject, getVerifyTemplate(user))
	if err != nil {
		logs.LogError(err)
	}
...
func getVerifyTemplate(user users.User) string {
	...
	<body style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
		...
		<tr>
		<td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;text-align:center;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px">This email was used to create an account on infinance.app To verify your account click the link bellow or use confirmation code.</p></td>
		</tr>
		</table></td>
		</tr>
		</table></td>
